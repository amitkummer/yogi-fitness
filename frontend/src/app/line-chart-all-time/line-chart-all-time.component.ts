...
@Component({
  selector: 'app-line-chart-all-time',
  templateUrl: './line-chart-all-time.component.html',
  styleUrls: ['./line-chart-all-time.component.scss']
})
export class LineChartAllTimeComponent {
  ...
  public lineChartOptions: ChartConfiguration['options'] = {
    ...
    plugins: {
      title: {
        text: "Average Workout Statistics Per Month (All Time)",
        display: true
      }
    }
  };
